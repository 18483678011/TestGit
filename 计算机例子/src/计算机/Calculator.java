...
public class Calculator extends JFrame {
	...
	public Calculator() {
		...
		JPanel displayPanel = new JPanel();// JPanelÊÇjavaÍ¼ÐÎ»¯½çÃæÖÐ×î³£Ê¹ÓÃµÄÈÝÆ÷¡£ÊµÀý£ºÔÚ´°ÌåÖÐÌí¼ÓÒ»¸öÀ¶É«µÄÃæ°å
		...
		buttonPanel.setLayout(new GridLayout(4, 4, 5, 5));// Ê¹ÓÃÍø¸ñ²¼¾Ö
