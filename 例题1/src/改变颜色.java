...
public class 改变颜色 extends JFrame {
	...
	public 改变颜色() {
		...
		button1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				label.setForeground(do_button1_actionPerformed(e));
		...
		button2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				label_2.setForeground(do_button2_actionPerformed(e));
			}
		});
	...
	protected Color do_button1_actionPerformed(ActionEvent e) {
		setColor(label1);// 指定标签的颜色设置
		Color nsColor = label1.getBackground();
		return nsColor;
	}
	...
	protected Color do_button2_actionPerformed(ActionEvent e) {
		setColor(label2);
		Color nsColor = label2.getBackground();
		return nsColor;
	}
